...
item_data = {
    'item1': {'Name': 'fivestar chocolates', 'Price': 10.0, 'Quantity': 40},
    'item2': {'Name': 'dairymilk chocolates', 'Price': 35.0, 'Quantity': 15},
    'item3': {'Name': 'kitkat chocolates', 'Price': 15.0, 'Quantity': 15},
    'item4': {'Name': 'snickers chocolates', 'Price': 20.0, 'Quantity': 15},
    'item5': {'Name': 'biscuits',            'Price':10.0, 'Quantity': 20},
...
def write_itemized_bill_and_update_quantities(item_cart, total_bill, file):
    with open("c:\\newfile\\nani.txt", 'a+') as file:
